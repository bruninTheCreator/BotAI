    ...
    def track(logger: Logger):
        ...
        def decorator(func):
            ...
            def wrapper(*args, **kwargs):
                with PerformanceTracker(logger, f"{func.__module__}.{func.__name__}"):  # noqa: E501
